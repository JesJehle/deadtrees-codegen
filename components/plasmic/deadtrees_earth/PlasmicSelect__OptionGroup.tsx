...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: j_SUJcQ3b-X7/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: fOMLYs5CwKlU/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__hBG9)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__k8Azf)}
              />
            </React.Fragment>
          ),
          value: args.children
