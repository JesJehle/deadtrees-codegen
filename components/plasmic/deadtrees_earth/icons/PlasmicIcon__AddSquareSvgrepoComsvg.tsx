...
export function AddSquareSvgrepoComsvgIcon(
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M12.75 9a.75.75 0 00-1.5 0v2.25H9a.75.75 0 000 1.5h2.25V15a.75.75 0 001.5 0v-2.25H15a.75.75 0 000-1.5h-2.25V9z"
        }
        fill={"currentColor"}
      ></path>
