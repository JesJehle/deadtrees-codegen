...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: hk2pkBiK-F8H/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_hKLmaWjWa4F_"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___0RxFs)}
              >
                <div
                  className={classNames(
                    projectcss.all,
